...
class InlineContentAd : public InlineContentAdObserver {
 ...
 private:
  ...
  void NotifyInlineContentAdEvent(const InlineContentAdInfo& ad,
                                  const InlineContentAdEventType event_type);

  void NotifyInlineContentAdViewed(const InlineContentAdInfo& ad);
  void NotifyInlineContentAdClicked(const InlineContentAdInfo& ad);
